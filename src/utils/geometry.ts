// utils/geometry.ts - Geometric utilities and hit detection

import type { Point, Hotspot, GridLayout, MarkType } from '../engine/types';

/**
 * Geometry utilities for point-in-shape detection and hotspot generation
 */
export class Geometry {
  /** Point-in-rectangle test (AABB - Axis-Aligned Bounding Box) */
   ...
   * Ray is cast from the point to infinity in the +x direction
   * Count intersections with polygon edges - odd = inside, even = outside
   */
   ...
   * Creates a regular grid of rectangular hotspots
   */
