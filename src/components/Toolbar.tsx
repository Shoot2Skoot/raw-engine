    ...
    <div className="flex items-center justify-between p-4 bg-gray-100 rounded-lg border border-gray-300 mb-4">
      ...
      <div className="flex items-center gap-2">
        <button
          ...
          className="p-2 rounded-lg bg-white disabled:opacity-30 disabled:cursor-not-allowed hover:bg-gray-50"
          title="Undo (Ctrl+Z)"
        >
          <Undo size={20} />
        </button>
        ...
        <button
          onClick={handleSave}
          className="px-4 py-2 rounded-lg bg-white hover:bg-gray-50 flex items-center gap-2"
          title="Save"
        >
          <Save size={20} />
        ...
        <button
          onClick={handleLoad}
          className="px-4 py-2 rounded-lg bg-white hover:bg-gray-50 text-sm font-medium"
          title="Load"
        >
          Load
        </button>
