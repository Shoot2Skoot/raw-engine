...
export const ValuePicker: React.FC<ValuePickerProps> = ({
  ...
  if (typeof window !== 'undefined') {
    const pickerWidth = tool === 'number' ? 200 : tool === 'text' || tool === 'pencil' ? 220 : 180;
    const pickerHeight = tool === 'number' ? 220 : 120;
    ...
    if (adjustedPosition.y + pickerHeight > window.innerHeight) {
      adjustedPosition.y = window.innerHeight - pickerHeight - 10;
    }
  }
