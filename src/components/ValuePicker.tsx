// components/ValuePicker.tsx - Popover for selecting mark values
...
/**
 * Popover component for selecting values for marks
 * Shows different pickers based on the current tool
 */
